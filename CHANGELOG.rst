...
- [Minor feature] added DataStore prototype.
- [Major feature] created DecProblem, a SimProblem variant that handles decision events
- [Bugfix] layout files had a bug where int of a float number was taken